         ...
         <table class="pure-table pure-table-bordered">
           ...
           <tbody>
             ...
             <tr>
              ...
              <td>${product.price}</td>
              <td>
               <button type="button" onclick="window.location.href='/spring.mvc/mvc/product/get/${status.index}';" 
                       class="pure-button pure-button-primary"> 更新</button>
              </td>
              <td>
               <button type="button" onclick="window.location.href='/spring.mvc/mvc/product/delete/${status.index}';" 
